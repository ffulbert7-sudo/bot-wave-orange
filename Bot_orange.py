...
def recevoir_sms():
    ...
    if not data:
        # On affiche quand même ce qu'on reçoit pour comprendre pourquoi c'est vide
        print(f"DEBUG: Données vides ou invalides reçues.", flush=True)
    ...
    print(f"Montant : {montant} FCFA", flush=True)
